package com.atlihao.springboot.hystrix;


import com.atlihao.springboot.hystrix.annotation.DoHystrix;
import com.atlihao.springboot.hystrix.valve.IValveService;
import com.atlihao.springboot.hystrix.valve.impl.HystrixValveImpl;
...
public class DoHystrixPoint {
    ...
    @Pointcut("@annotation(com.atlihao.springboot.hystrix.annotation.DoHystrix)")
