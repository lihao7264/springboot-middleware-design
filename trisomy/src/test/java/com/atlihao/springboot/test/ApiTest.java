...
/**
 * -noverify -javaagent:/Users/admin/Desktop/project/company/km-bot/2023-07-04/springboot-middleware-design/trisomy/target/Trisomy.jar
 * -javaagent:/Users/admin/Desktop/project/company/km-bot/2023-07-04/springboot-middleware-design/trisomy/target/Trisomy-sources.jar
 * 解决方案：
 * JDK1.8，在启动JVM参数加： -noverify   （1.8没有-XX:-UseSplitVerifier参数）
 * JDK1.7，在启动JVM参数加： -XX:-UseSplitVerifier
 */
public class ApiTest {
    ...
    public void method02(int i) {
        System.out.println("hi 测试 小朋友ID：" + i);
    }
    ...
    public void method03(String str) {
        System.out.println("hi 测试 小朋友ID：" + str);
    }
    ...
    public void method04(String name, int id) {
        System.out.println("hi 测试 小朋友：" + name + " ID：" + id);
    }
    ...
    public void method06(boolean a, char b, byte c, short s, int i, long l, int ss, long ld, double xx, int mm, int nn, double mmm) {
        System.out.println("hi 测试 基本类型全覆盖测试");
    }
...
//
    ...
    public void test_desc() {
        String desc = "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;IJ[I[[Ljava/lang/Object;Lcom/atlihao/test/Req;)Ljava/lang/String;";
