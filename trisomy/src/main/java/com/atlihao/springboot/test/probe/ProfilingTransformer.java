package com.atlihao.springboot.test.probe;

import com.atlihao.springboot.test.config.ProfilingFilter;
...
public class ProfilingTransformer implements ClassFileTransformer {
    ...
    private static void outputClazz(byte[] bytes, String className) {
        ...
        try {
            String pathName = "E:\\atlihao\\git\\MiddlewareDesign\\trisomy\\target\\test-classes\\" + className + "trisomy.class";
