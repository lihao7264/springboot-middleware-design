package com.atlihao.springboot.schedule.service;
...
import com.atlihao.springboot.schedule.task.SchedulingRunnable;
import com.atlihao.springboot.schedule.util.StrUtil;
...
import static com.atlihao.springboot.schedule.common.Constants.Global.LINE;
import static com.atlihao.springboot.schedule.common.Constants.Global.path_root;
            ...
            switch (event.getType()) {
                ...
                case NODE_UPDATED:
                    if (Constants.Global.ip.equals(instruct.getIp()) && Constants.Global.schedulerServerId.equals(instruct.getSchedulerServerId())) {
                        // 获取对象
                        CronTaskRegister cronTaskRegistrar = applicationContext.getBean("schedule-cronTaskRegister", CronTaskRegister.class);
                        ...
                        String path_root_server_ip_clazz_method_status = StrUtil.joinStr(path_root, LINE, "server", LINE, instruct.getSchedulerServerId(), LINE, "ip", LINE, instruct.getIp(), LINE, "clazz", LINE, instruct.getBeanName(), LINE, "method", LINE, instruct.getMethodName(), "/status");
                        // 执行命令
