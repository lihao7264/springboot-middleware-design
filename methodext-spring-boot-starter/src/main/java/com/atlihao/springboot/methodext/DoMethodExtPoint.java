package com.atlihao.springboot.methodext;

import com.alibaba.fastjson.JSON;
import com.atlihao.springboot.methodext.annotation.DoMethodExt;
...
public class DoMethodExtPoint {
    ...
    @Pointcut("@annotation(com.atlihao.springboot.methodext.annotation.DoMethodExt)")
